...
function shareResult(event) {
    ...
    let originalNodes = [];
    if (targetBtn) {
        // Clone original nodes synchronously
    ...
    if (navigator.share) {
        ...
        if (targetBtn) {
            ...
            targetBtn.appendChild(loadingSpan);

            const loadingText = document.createTextNode(' 복사 중...');
            targetBtn.appendChild(loadingText);
        }
        ...
        navigator.clipboard.writeText(shareText).then(() => {
            if (targetBtn) {
                ...
                targetBtn.appendChild(successText);
            ...
            if (targetBtn) {
                ...
                const errorText = document.createTextNode(' 복사 실패');
                targetBtn.appendChild(errorText);
